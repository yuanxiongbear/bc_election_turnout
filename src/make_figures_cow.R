...
"This script is the second plot script of milestone 2 of 522 group19 project. This
script takes in the processed data generated by script#2 and generates a cow plot.
