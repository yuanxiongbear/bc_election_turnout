...
# This scripts download the 2017 British Columbia voting data sets from the provincial Data Catalogue website and converge it
# into a dataframe that is usable for following studies. 

# Usage: Rscript download_url_csv.R
