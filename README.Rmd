...
To download the data, generate the figures, and replicate the analysis of this project you need to clone this repository and install all dependencies listed below. Once that is complete, you need to run the Makefile from the root of this project by executing the following from the command line:
...
To install all dependencies, run the following command in the RStudio console
