...
\begin{figure}
\includegraphics[width=1\linewidth]{images/scatter_plot} \caption{Figure 1. A scatter plot displaying competitiveness vs turnout}\label{fig:unnamed-chunk-2}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{images/cow_plot} \caption{Figure 2. Q-Q plot for competitiveness and turnout.}\label{fig:unnamed-chunk-3}
\end{figure}
